 ...
 * @Last modified time: 2017-10-16T00:25:17+03:00
 */
  ...
  render(){
    ...
    return(
      ...
      <li className="list-group-item" style={{cursor:'pointer'}}>
       ...
       <button  key={"1"}  className="btn btn-success"style={{marginLeft:20}} onClick={()=>{this.onSendPress(dispatch,this.props.invitation)}}>send Invitation</button>
         <button  key={"2"}  className="btn btn-danger"style={{marginLeft:10}} onClick={()=>{this.onRejectPress(dispatch,this.props.invitation)}}>Reject</button>
       </h5>
      </li>
    )
